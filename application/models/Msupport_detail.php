<?php
class Msupport_detail extends CI_Model
{
    protected $_table = 'support_detail';
     ...
     * get sales detail
     */
    public function get_support_detail($sale_id){
     ...
     * list detail
     */
    public function get_all_support_detail($support_id){
