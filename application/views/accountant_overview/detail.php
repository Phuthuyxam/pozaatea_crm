...
<div class="row small-spacing">
                ...
                <div class="box-content card" id="care_note">
                    ...
                    <div class="card-content">
                        <form method="post" action="">
                            <div class="row">
                                <div class="col-xs-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  name="name_work">
                            ...
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea class="form-control" cols="50" rows="50" name="description"></textarea>
    ...
    <?php endif; ?>
            ...
            <div class="col-xs-12">
                    ...
                    <div class="card-content">
                        <div class="table-responsive" id="todolist">
                            ...
                            <table id="example-table" class="table table-striped table-bordered display" style="width:100%">
                                ...
                                <?php
                                if(@$list_accountant_detail):
                                    $count = 0;
                                    foreach (@$list_accountant_detail as $item):
                                        $count++;
                                        ?>
                                        <tr id="<?php echo @$item['id']; ?>">
                                            ...
                                            <td>
                                                <input type="hidden" id="detail_id" name="detail_id" value="<?php echo $item['id']; ?>">
                                                <input type="hidden" id="account_id" name="care_id" value="<?php echo $item['account_id']; ?>">
                                                <!-- check quyen edit -->
                ...
                <!-- /.box-content card -->
                <a href="<?php echo base_url('accountant_overview/index'); ?>" class="btn btn-primary">Quay lại</a>
            </div>
            <!-- /.col-md-6 -->
...
<script>
    $(document).ready(function(){
        ...
        $('#deleteEmpForm').on('submit',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('accountant_overview/del_detail'); ?>",
                dataType : "text",
                data : {
                    id:empId
                },
        ...
        $('#editEmpForm').on('submit',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('accountant_overview/detail'); ?>",
                dataType : "text",
                data : {
