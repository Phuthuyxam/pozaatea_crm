    ...
    <div class="col-xs-12">
        <div class="box-content">
            <form action="" method="post">
                ...
                <a href="<?php echo base_url(); ?>accountant_overview/index" type="button" class="btn btn-primary">
                    Xóa lọc
                </a>
            </form>
        </div>
...
<!--                <a href="--><?php //echo base_url('accountant_overview/export'); ?><!--" class="btn btn-primary">-->
<!--                    Export-->
<!--                </a>-->
            </h4>
                    ...
                    if($list_customers):
                        ...
                        foreach ($list_customers as $item):
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('accountant_overview/detail/'.$item['id']); ?>" type="button" class="btn btn-primary">
