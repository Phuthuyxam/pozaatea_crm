...
<!--                            </form>-->
                ...
                <!-- /.box-content card -->
                <a href="<?php echo base_url('care_overview/index'); ?>" class="btn btn-primary">Quay lại</a>
            </div>
            <!-- /.col-md-6 -->
...
<script>
    $(document).ready(function(){
        ...
        $('#deleteEmpForm').on('submit',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('care_overview/del_detail'); ?>",
                dataType : "text",
                data : {
                    id:empId
                },
        ...
        $('#editEmpForm').on('submit',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('care_overview/detail'); ?>",
                dataType : "text",
                data : {
