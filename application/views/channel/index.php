    ...
    <div class="col-xs-12">
        <div class="box-content">
            ...
            <h4 class="box-title">
                ...
                <a href="<?php echo base_url(); ?>channel/add" type="button" class="btn btn-primary">
                    Thêm mới
                </a>
                <?php endif; ?>
            </h4>
            ...
            if($this->session->flashdata('msg_channel_success')){
                ?>
                <div class="alert alert-success" role="alert">
                    <strong>Success!</strong> <?php echo $this->session->flashdata('msg_channel_success'); ?>.
            ...
            if($this->session->flashdata('msg_channel_error')){
                ?>
                <div class="alert alert-warning" role="alert">
                    <strong>Error!</strong> <?php echo $this->session->flashdata('msg_channel_error'); ?>.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    foreach ($list_channel as $item):
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url().'channel/edit/'.$item['id']; ?>" type="button" class="btn btn-primary">
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url().'channel/del/'.$item['id']; ?>" onclick="return confirm('Are you sure?')" type="button" class="btn btn-primary">
