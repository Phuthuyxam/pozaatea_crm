...
<div class="row small-spacing">
                ...
                <div class="box-content card" id="care_note">
                    ...
                    <div class="card-content">
                        <form method="post" action="">
                            ...
                            <button type="submit" class="btn btn-primary" name="action" value="add_action_design" >Thêm công việc</button>
                        </form>
                    </div>
                    <!-- /.card-content -->
                </div>
    ...
    <?php endif; ?>
            ...
            <div class="col-xs-12">
                                    ...
                                    foreach (@$list_design_detail as $item):
                                        ...
                                        <tr id="<?php echo @$item['id']; ?>">
                                            ...
                                            <td>
                                                ...
                                                <input type="hidden" id="design_id" name="design_id" value="<?php echo $item['design_id']; ?>">
                                                <!-- check quyen view -->
                ...
                <!-- /.box-content card -->
                <a href="<?php echo base_url('design_overview/index'); ?>" class="btn btn-primary">Quay lại</a>
            </div>
            <!-- /.col-md-6 -->
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <select name="empStatus" id="empStatus" class="form-control">
                            <?php
                            $status_process  = $this->globals->get_all_status_process();
                            if($status_process):
                                foreach ($status_process as $item):
                                    ?>
...
<script>
    $(document).ready(function(){
        ...
        $('#deleteEmpForm').on('submit',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('design_overview/del_detail'); ?>",
                dataType : "text",
                data : {
                    id:empId
                },
        ...
        $('#editEmpForm').on('submit',function(){
            ...
            $.ajax({
                type : "POST",
                url  : "<?php echo base_url('design_overview/detail'); ?>",
                dataType : "text",
                data : {
