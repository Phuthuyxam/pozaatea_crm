...
<!--                <a href="--><?php //echo base_url('design_overview/export'); ?><!--" class="btn btn-primary">-->
<!--                    Export-->
<!--                </a>-->
            </h4>
                    ...
                    if($list_customers):
                        ...
                        foreach ($list_customers as $item):
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo base_url('design_overview/detail/'.$item['id']); ?>" type="button" class="btn btn-primary">
