    ...
    <div class="col-xs-12">
        <div class="box-content">
            ...
            <?php if(in_array("add", $arr_permission_check)): ?>
                <a href="<?php echo base_url(); ?>groups/add" type="button" class="btn btn-primary">
                    Thêm mới
                </a>
            <?php endif; ?>
            </h4>
            ...
            if($this->session->flashdata('msg_groups_success')){
                ?>
                <div class="alert alert-success" role="alert">
                    <strong>Success!</strong> <?php echo $this->session->flashdata('msg_groups_success'); ?>.
            ...
            if($this->session->flashdata('msg_groups_error')){
                ?>
                <div class="alert alert-warning" role="alert">
                    <strong>Error!</strong> <?php echo $this->session->flashdata('msg_groups_error'); ?>.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                    ...
                    foreach ($list_groups as $item):
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url().'groups/edit/'.$item['id']; ?>" type="button" class="btn btn-primary">
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url().'groups/del/'.$item['id']; ?>" onclick="return confirm('Are you sure?')" type="button" class="btn btn-primary">
