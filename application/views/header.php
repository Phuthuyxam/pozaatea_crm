...
<div class="main-menu">
    <header class="header">
        <a href="<?php echo base_url('home/index'); ?>" class="logo"><i class="ico mdi mdi-cube-outline"></i>MyAdmin</a>
        <button type="button" class="button-close fa fa-times js__menu_close"></button>
        <div class="user">
            <a href="#" class="avatar"><img src="<?php echo base_url()?>assets/images/logo1.png" alt=""><span class="status online"></span></a>

            <h5 class="name"><a href="<?php echo base_url('users/profile'); ?>"><?php echo @$login['user_login_name']; ?></a></h5>
            <h5 class="position"><?php echo @$login['user_login']; ?></h5>
            <!-- /.name -->
            <div class="control-wrap js__drop_down">
                <i class="fa fa-caret-down js__drop_down_button"></i>
                <div class="control-list">
                    <div class="control-item"><a href="<?php echo base_url('users/profile'); ?>"><i class="fa fa-user"></i> Thông tin cá nhân</a></div>
                    <div class="control-item"><a href="<?php echo base_url('auth/logout'); ?>"><i class="fa fa-sign-out"></i> Đăng xuất</a></div>
                </div>
                <!-- /.control-list -->
            </div>
            <!-- /.control-wrap -->
