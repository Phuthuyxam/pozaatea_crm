        ...
        <div class="box-content">
            <form method="post" action="" data-toggle="validator">
                <div class="form-group">
                    <label for="inputEmail" class="control-label">Tên cấp độ</label>
                    <input type="number" name="name" value="<?php echo (@$_POST['name'])?@$_POST['name']:$info['name']; ?>" class="form-control" id="inputEmail" placeholder=""  >
                    <?php echo form_error('name', '<div class="error" style="color: red;">', '</div>'); ?>
                </div>

                <div class="form-group">
                    <button type="submit" class="btn btn-primary waves-effect waves-light">Cập nhật</button>
                    <a href="<?php echo base_url();?>level/index" class="btn btn-primary">Quay lại danh sách</a>
                </div>
            </form>
        </div>
    </div>
