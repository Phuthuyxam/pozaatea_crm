        ...
        <div class="box-content">
            <form method="post" action="" data-toggle="validator">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="description" value="<?php echo isset($_POST['description'])?$_POST['description']:''; ?>" class="form-control" id="inputName" placeholder="Mô tả" >
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="price_im" value="<?php echo isset($_POST['price_im'])?$_POST['price_im']:''; ?>" class="form-control" id="inputEmail" placeholder="Giá nhập"  >
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="price_ex1" value="<?php echo isset($_POST['price_ex1'])?$_POST['price_ex1']:''; ?>" class="form-control" id="inputEmail" placeholder="Giá bán cấp 1"  >
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="price_ex2" value="<?php echo isset($_POST['price_ex2'])?$_POST['price_ex2']:''; ?>" class="form-control" id="inputEmail" placeholder="Giá bán cấp 2"  >
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="price_ex3" value="<?php echo isset($_POST['price_ex3'])?$_POST['price_ex3']:''; ?>" class="form-control" id="inputEmail" placeholder="Giá bán cấp 3"  >
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="price_ex4" value="<?php echo isset($_POST['price_ex4'])?$_POST['price_ex4']:''; ?>" class="form-control" id="inputEmail" placeholder="Giá bán cấp 4"  >
                ...
                <div class="form-group">
                    ...
                    <input type="number" min="0" name="price_single" value="<?php echo isset($_POST['price_single'])?$_POST['price_single']:''; ?>" class="form-control" id="inputEmail" placeholder="Giá bán lẻ"  >
                    <?php echo form_error('price_single', '<div class="error" style="color: red;">', '</div>'); ?>
                </div>
                <!-- ************ -->
                <div class="form-group">
                    <label for="inputName" class="control-label">Đơn vị</label>
                    <input type="text" name="unit" value="<?php echo isset($_POST['unit'])?$_POST['unit']:'';; ?>" class="form-control" id="inputName" placeholder="" >
