...
<div id="single-wrapper">
    <form method="post" action="" class="frm-single">
        <div class="inside">
            ...
            <!-- /.title -->
            <div class="frm-title">Đăng nhập hệ thống ủy quyền</div>
            <?php
            ...
            <div class="clearfix margin-bottom-20">
                ...
                <!-- /.pull-left -->
                <div class="pull-right"><a href="<?php echo base_url('partner/auth/forgot'); ?>" class="a-link"><i class="fa fa-unlock-alt"></i>Quên mật khẩu?</a></div>
                <!-- /.pull-right -->
            </div>
            <!-- /.clearfix -->
