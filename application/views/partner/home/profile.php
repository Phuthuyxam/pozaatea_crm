        ...
        <div class="box-content">
            <form method="post" action="" data-toggle="validator">
                <div class="form-group">
                    ...
                    <input type="email" name="email" value="<?php echo @$info['email']; ?>" class="form-control" id="inputEmail" placeholder="Email" readonly >
                ...
                <div class="form-group">
                    ...
                    <a href="<?php echo base_url();?>partner/home/index" class="btn btn-primary">Quay lại trang chủ</a>
                </div>
            </form>
        </div>
    </div>
