        ...
        <div class="box-content">
            <form method="post" action="" data-toggle="validator">
                <div class="form-group">
                    <label for="inputEmail" class="control-label">Tên dịch vụ</label>
                ...
                <div class="form-group">
                    <label for="inputEmail" class="control-label">Phí dịch vụ</label>
                    <input type="number" name="fee" value="<?php echo (@$_POST['fee'])?@$_POST['fee']:$info['fee']; ?>" class="form-control" id="inputEmail" placeholder=""  >
                ...
                <div class="form-group">
                    ...
                    <a href="<?php echo base_url();?>services/index" class="btn btn-primary">Quay lại danh sách</a>
                </div>
            </form>
        </div>
    </div>
