    ...
    <div class="col-xs-12">
        <div class="box-content">
            ...
            <h4 class="box-title">
                ...
                <a href="<?php echo base_url(); ?>services/add" type="button" class="btn btn-primary">
                    Thêm mới
                </a>
                <?php endif; ?>
            </h4>
                ...
                if($list_services):
                    ...
                    foreach ($list_services as $item):
                        ...
                        <tr>
                            ...
                            <td><?php echo number_format($item['fee']); ?> VNĐ</td>
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url().'services/edit/'.$item['id']; ?>" type="button" class="btn btn-primary">
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url().'services/del/'.$item['id']; ?>" onclick="return confirm('Are you sure?')" type="button" class="btn btn-primary">
