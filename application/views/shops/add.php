    ...
    <div class="col-xs-12">
        ...
        <form method="post" action="" data-toggle="validator">
            ...
            <div class="form-group">
                ...
                <input type="text" name="shop_name" value="<?php echo isset($_POST['shop_name'])?$_POST['shop_name']:''; ?>" class="form-control" id="inputName" placeholder="Name"  >
            ...
            <div class="form-group">
                ...
                <input type="text" name="shop_address" value="<?php echo isset($_POST['shop_address'])?$_POST['shop_address']:''; ?>" class="form-control" id="inputAddress" placeholder="Address" >
