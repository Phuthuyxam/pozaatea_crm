    ...
    <div class="col-xs-12">
        <div class="box-content">
            ...
            <h4 class="box-title">
                ...
                <a href="<?php echo base_url(); ?>shops/add" type="button" class="btn btn-primary">
                    Thêm mới
                </a>
                <?php endif; ?>
            </h4>
            ...
            <table id="example-table" class="table table-striped table-bordered display" style="width:100%">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url().'shops/edit/'.$item['id']; ?>" type="button" class="btn btn-primary">
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url().'shops/del/'.$item['id']; ?>" onclick="return confirm('Are you sure?')" type="button" class="btn btn-primary">
