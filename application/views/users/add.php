    ...
    <div class="col-xs-12">
        ...
        <form method="post" action="" data-toggle="validator">
            ...
            <div class="form-group">
                ...
                <input type="text" name="fullname" value="<?php echo isset($_POST['fullname'])?$_POST['fullname']:''; ?>" class="form-control" id="inputName" placeholder="" >
            ...
            <div class="form-group">
                ...
                <input type="checkbox"  name="is_sale" value="1" <?php echo (@$_POST['is_sale'] == 1)?'checked':''; ?>  class="form-control btn-sm" id="inputName" placeholder="" >
