    ...
    <div class="col-xs-12">
        <div class="box-content">
            ...
            <h4 class="box-title">
                ...
                <a href="<?php echo base_url(); ?>users/add" type="button" class="btn btn-primary">
                    Thêm mới
                </a>
                <?php endif; ?>
            </h4>
            ...
            <table id="example-table" class="table table-striped table-bordered display" style="width:100%">
                ...
                <tr>
                    ...
                    <?php
                    $group = $this->globals->get_group($item['group_id']);
                    ?>
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url().'users/edit/'.$item['id']; ?>" type="button" class="btn btn-primary">
                    ...
                    <td>
                        ...
                        <a href="<?php echo base_url().'users/del/'.$item['id']; ?>" onclick="return confirm('Are you sure?')" type="button" class="btn btn-primary">
